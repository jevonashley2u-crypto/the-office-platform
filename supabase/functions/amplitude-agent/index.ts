...
// Every 4 hours — continuous funnel monitoring
Deno.cron("Amplitude Agent Execution", "0 */4 * * *", async () => {
...
/* To invoke locally:
  ...
  curl -i --location --request POST 'http://127.0.0.1:54321/functions/v1/amplitude-agent' \
